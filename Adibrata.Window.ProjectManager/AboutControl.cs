...
namespace Adibrata.Window.ProjectManager
{
    public partial class AboutControl : UserControl
    {
        ...
        private void InitializeUI()
        {
            ...
            this.lblCopyright.Text = Utilities.GetLocalizedString(AboutControl.Copyright);
            this.lblVersion.Text = string.Format("{0}: {1}", Utilities.GetLocalizedString("Version"), AboutControl.Version);

            Stream stream = Utilities.GetEmbeddedResourceStream("Adibrata.Window.ProjectManager.Images.Logo.PNG");
