...
using System.Data;
namespace Adibrata.BusinessProcess.Paging.Extend.LicenseMaintenance
{
    public class LicenseMaintenance
    {
        static string Connectionstring = AppConfig.Config("ConnectionString");
        public virtual DataTable LicenseMaintenancePaging(PagingEntities _ent)
        {
            DataTable _dt = new DataTable();
            StringBuilder sb = new StringBuilder();
            try
            {
                sb.Append("spLicenseMaintenancePaging");
            ...
            catch (Exception _exp)
            {
                ErrorLogEntities _errent = new ErrorLogEntities
                {
                    ...
                    ClassName = "LicenseMaintenance",
                    FunctionName = "LicenseMaintenancePaging",
                    ExceptionNumber = 1,
