...
public partial class StoredProcedures
{
    ...
    public static void AmendmentInquiry (
        ...
        )
    {
        ...
        if (sortby != "")
        { sb.Append(sortby); }
        else { sb.Append("AmendmentCode"); }

        sb.Append(") as number, ");

        #endregion
        sb.Append("ID, AmendmentID, AmendmentCode, AmendmentType, AppCode, OfficeCode, RequestDate, ApprovedDate, ExecuteDate  Address From AmendmentTrx with (nolock)");
