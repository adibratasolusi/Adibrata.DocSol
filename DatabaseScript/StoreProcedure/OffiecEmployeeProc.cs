...
public partial class StoredProcedures
{
    ...
    public static void OffiecEmployeePaging(
                     Int32 currentpage,
                    Int32 pagesize,
                    String wherecond,
                    String sortby)
    {
        ...
        if (sortby != "")
        { sb.Append(sortby); }
        else { sb.Append("EmployeeName"); }

        sb.Append(") as number, ");

        #endregion
        sb.Append("ID, EmployeeCode, EmployeeName, EmployeePositionID From BranchEmployeeView with (nolock)");
