...
namespace Adibrata.Window.ProjectManager
{
    public partial class SplashScreen : Form
    {
        ...
        {
            Adibrata.Window.ProjectManagerForm.InitializationStatusChanged += new InitializationStatusChangedEventHandler(this.Application_InitializationStatusChanged);
            Adibrata.Window.ProjectManagerForm.InitializationComplete += new EventHandler(this.Application_InitializationComplete);
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            Adibrata.Window.ProjectManagerForm.SplashLoadedEvent.Set();
        }
        #endregion //OnLoad
