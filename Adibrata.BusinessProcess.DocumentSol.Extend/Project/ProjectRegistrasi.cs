    ...
    public class ProjectRegistrasi : Adibrata.BusinessProcess.DocumentSol.Core.ProjectRegistrasi
    {
        ...
        public virtual void ProjectRegistrasiAdd(DocSolEntities _ent)
        {
            ...
            try
            {
                ...
                sqlParams[1] = new SqlParameter("@ProjName", SqlDbType.VarChar, 50);
                sqlParams[1].Value = _ent.ProjectName;
                sqlParams[2] = new SqlParameter("@ProjType", SqlDbType.VarChar, 50);
                sqlParams[2].Value = _ent.ProjectType;
