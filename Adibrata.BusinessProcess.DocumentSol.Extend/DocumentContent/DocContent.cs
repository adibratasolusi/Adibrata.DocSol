...
namespace Adibrata.BusinessProcess.DocumentSol.Extend
{
    public class DocContent : Adibrata.BusinessProcess.DocumentSol.Core.DocContent.DocContent
    {
        ...
        public virtual DataTable DocSavePassword(DocSolEntities _ent)
        {
            SqlConnection _conn = new SqlConnection(ConnectionString);
            string password = Encryption.EncryptToSHA3(_ent.Password);
            //string _passwordstore = (string)SqlHelper.ExecuteScalar(Connectionstring, CommandType.Text, sb.ToString(), sqlParams);
            ...
            try
            {
                ...
                sqlParams[0] = new SqlParameter("@DocTransId", SqlDbType.BigInt);
                sqlParams[0].Value = _ent.DocTransId;
                sqlParams[1] = new SqlParameter("@PassDoc", SqlDbType.VarChar, 800);
                ...
                //_dtValue.Load(SqlHelper.ExecuteReader(ConnectionString, CommandType.StoredProcedure, sb.ToString(), sqlParams));
                SqlHelper.ExecuteNonQuery(_trans, CommandType.StoredProcedure, "spInsertDocTransPassword", sqlParams);
                _trans.Commit();
        ...
        public virtual DataTable DocUpdatePassword(DocSolEntities _ent)
        {
            SqlConnection _conn = new SqlConnection(ConnectionString);
            string password = Encryption.EncryptToSHA3(_ent.Password);
            //string _passwordstore = (string)SqlHelper.ExecuteScalar(Connectionstring, CommandType.Text, sb.ToString(), sqlParams);
   ...
   //_dtValue.Load(SqlHelper.ExecuteReader(ConnectionString, CommandType.StoredProcedure, sb.ToString(), sqlParams));
                SqlHelper.ExecuteNonQuery(_trans, CommandType.StoredProcedure, "spDocTransPasswordUpdate", sqlParams);
                _trans.Commit();
        ...
        public virtual DataTable DocOpenPassword(DocSolEntities ent)
        {
            ...
            try
            {
                sb.Append("spDocTransPasswordCheck");
               
                SqlParameter[] sqlParams = new SqlParameter[2];
                sqlParams[0] = new SqlParameter("@DocTransId", SqlDbType.BigInt);
                sqlParams[0].Value = ent.DocTransId;
                sqlParams[1] = new SqlParameter("@pass", SqlDbType.VarChar, 200);
                sqlParams[1].Direction = ParameterDirection.Output;

                //_passwordstore = (string)SqlHelper.ExecuteScalar(ConnectionString, CommandType.Text, sb.ToString(), sqlParams);
               
                _dtp.Load(SqlHelper.ExecuteReader(ConnectionString, CommandType.StoredProcedure, "spDocTransPasswordCheck", sqlParams));
                ent.PasswordStore = Convert.ToString(sqlParams[1].Value);
                //_passwordstore = (string)SqlHelper.ExecuteScalar(ConnectionString, CommandType.Text, sb.ToString(), sqlParams);
        ...
        //public virtual DataTable DocValidPassword(DocSolEntities ent)
        //{
        ...
        //        sqlParams[0] = new SqlParameter("@DocTransId", SqlDbType.BigInt);
        //        sqlParams[0].Value = ent.DocTransId;
        //        sqlParams[1] = new SqlParameter("@Username", SqlDbType.VarChar, 200);
        //        sqlParams[1].Direction = ParameterDirection.Output;

        //        //SqlHelper.ExecuteNonQuery(ConnectionString, CommandType.StoredProcedure, "spDocTransPasswordValid", sqlParams);


        //        _dt.Load(SqlHelper.ExecuteReader(ConnectionString, CommandType.StoredProcedure, "spDocTransPasswordValid", sqlParams));
        //        ent.UserName = Convert.ToString(sqlParams[1].Value);
        //    }
        //    catch (Exception _exp)
        //    {
