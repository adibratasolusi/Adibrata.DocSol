...
public partial class StoredProcedures
{
    ...
    public static void MSFormPaging(
                    Int32 currentpage,
                    Int32 pagesize,
                    String wherecond,
                    String sortby)
    {
        ...
        if (sortby != "")
        { sb.Append(sortby); }
        else { sb.Append("FormName"); }

        sb.Append(") as number, ");

        #endregion
        sb.Append("ID, FormName, FormFileName From Ms_Form with (nolock)");
    ...
    [Microsoft.SqlServer.Server.SqlProcedure]
    public static void MSFormAdd()
    {
        // Put your code here
    }
    
    [Microsoft.SqlServer.Server.SqlProcedure]
    public static void MSFormEdit()
    {
        // Put your code here
    }

    [Microsoft.SqlServer.Server.SqlProcedure]
    public static void MSFormDelete()
    {
        // Put your code here
    }
}
